...
テーマ依存度が低下してもライセンスを購入し続けてもらうために付加価値をつける必要がある
...
<ul>
<li data-marpit-fragment="1" data-bespoke-marp-fragment="inactive"><i class="fa-regular fa-face-frown"></i> 最初の段階で必要な<b class="text-danger">ページ構成を考えられない</b><li>
<li data-marpit-fragment="1" data-bespoke-marp-fragment="inactive"><i class="fa-regular fa-face-frown"></i> <b class="text-danger">文章を考えられない</b></li>
...
実際に自分で組むのは <b class="text-danger">かなり面倒</b>
