...
<!-- 
like me, the
Business model of theme developers is
...
Theme developers could get rewarded
...
### Then as someone <br>who made a living out of theme sales...
...
* Expected to taper off due to less reliance 
on the theme

* Even if sell only the pattern, it seems to be difficult 
because even users have the impression that 
they can make them on their own.
...
* The design and sample sentences are <br><b class="text-danger">more elaborate are ready to use</b>.
