...
<b>Theme Lightning</b> published on wordpress.org<br>
...
<b>Block theme X-T9</b> released<br>
...
<i class="fa-solid fa-sack-dollar"></i> <b>Relatively possible to sell and make money.</b></div>
...
It has become difficult to monetize traditional "theme sales".
...
As a result, I feel it has become difficult to monetize traditional "theme sales"
-->
...
<i class="fa-regular fa-thumbs-up"></i> <b>New extensibility</b> and <b>monetization points</b>.
</div>
...
<div class="alert alert-warning mt-22">
...
|＝ｗ＝）.oO（ We can't monetize only with the .org pattern directory... ）
...
<h3 style="padding-bottom:48vh">3. Link function for favorite registered patterns</h3>
...
<li data-marpit-fragment="1" data-bespoke-marp-fragment="inactive" class="mt-42 ls-none">
	<div class="alert alert-info">
...
<b>the importance of the theme is high.</b>
...
Adobe Illustrator ≠ Anyone can create high-quality designs to match their purpose
</div>
...
but not everyone can create high-quality designs match their purpose, right?
-->
...
<li data-marpit-fragment="2" data-bespoke-marp-fragment="inactive">Layout on multiple widths are actually not that easy</li>
...
If a theme/pattern to meet user's purpose is available, user can have website faster by purchasing it.
-->
