...
<ul>
<li>Must be in the language of the country</li>
<li>A design optimized for each language (characters/typefaces) is better</li>
<li>Content and design trends vary by region (country)</li>
<li class="mt-40 ls-none">
	<div class="alert alert-info">
...
<ul>
<li>With a single screen width, <br>
it might be possible to lay out well somehow.</li>
<li>Layout on multiple widths are actually not that easy</li>
<li class="ls-none mt-32">
<div class="alert alert-info">
