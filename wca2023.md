...
<b>2012</b> First General-purpose theme published.
</span>
...
* <b>Expected to taper off due to 
less reliance on the theme</b>
...
* Expected to taper off due to 
less reliance on the theme
...
<span class="text-danger"><i class="fa-solid fa-brush"></i> **Premium Pattern**
...
<li data-marpit-fragment="1" data-bespoke-marp-fragment="inactive"><b class="text-danger">User can use both</b><br>
  the classic theme and the new block theme</li>
<li data-marpit-fragment="1" data-bespoke-marp-fragment="inactive"><b class="text-danger">Keep existing users by the value of the pattern library</b><br>
...
<li data-marpit-fragment="1" data-bespoke-marp-fragment="inactive"><b class="text-danger">Acquire new users</b><br>
  through the value of our pattern library</li>
...
* Keep existing users by the value of the pattern library

* Acquire new users through the 
value of our pattern library
