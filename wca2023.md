...
<ul>
<li><b class="text-danger">User can use both</b><br>
  the classic theme and the new block theme
<li><b class="text-danger">Keep existing users by the value of the pattern library</b><br>
  even if the value of the classic theme declines
<li><b class="text-danger">Acquire new users</b><br>
  through the value of your pattern library
