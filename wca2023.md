...
<h4 class="text-center mb-32">Theme License</h4>
...
<!-- 
私達は、以前はテーマに付随するプラグインを販売していましたが、
...
* ブロックテーマに移行しなくてはいけない
* パターンだけ販売しても、
パターンはユーザーでも自力で作れる印象があるため<br>売るのが難しそう
...
<h4 class="text-center mb-32">Passport License</h4>
...
<i class="fa-solid fa-plug"></i> **Block extension** plugin（ VK Blocks Pro ）
<i class="fa-solid fa-user-tie"></i> Support
<span class="text-danger"><i class="fa-solid fa-brush"></i> **Theme**（ X-T9 / Block Theme / Free ）
...
* 旧製品も新製品も両方使える
* クラシックテーマの評価価値が下がっても、<br>パターンライブラリの価値で既存ユーザーをキープ
* パターンライブラリの価値で他テーマのユーザーも取り込む
