...
In our case
Before FSE
We used to sell plugins that extend the functionality of the theme
 -->

---------------------------------------------------------------------------

* <b>Expected to taper off due to less reliance on theme</b>
...
* Have to move to block themes too


<!-- 
However

* Expected to taper off due to less reliance on theme
...
This configuration is aimed at 
...
even if the value of the classic theme declines

* Acquire new users
through the value of our pattern library
...
So we published our own block pattern directory
...
It is necessary to have the license continued 
even if the theme dependence decreases.
( Acquisition of new users )

That's why we offer the following services
